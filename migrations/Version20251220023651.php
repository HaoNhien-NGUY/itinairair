 ...
 */
final class Version20251220023651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE travel_item ADD CONSTRAINT FK_D443C6B379D92AEE FOREIGN KEY (end_day_id) REFERENCES day (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE travel_item ADD CONSTRAINT FK_D443C6B3C30DD6B6 FOREIGN KEY (start_day_id) REFERENCES day (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
